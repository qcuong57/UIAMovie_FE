// src/components/movie/movie/MovieInfoHero.jsx
// Hero section cho MovieInfoPage — backdrop, poster, title, meta pills, actions
// Props khớp với những gì MovieInfoPage truyền xuống
...
export default function MovieInfoHero({
  isMobile,
  movie,
  year,
  genreList,
        ...
        {!isMobile && (
          <motion.div
            ...
            style={{
              ...
              overflow: "hidden",
              boxShadow:
                "0 32px 80px rgba(0,0,0,0.85), 0 0 0 1px rgba(255,255,255,0.08)",
              order: 2,
            }}
          >
            {movie?.posterUrl ? (
