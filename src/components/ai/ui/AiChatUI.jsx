...
export const TypingDots = () => (
  <div style={{ display: "flex", gap: 5, alignItems: "center", height: 18, padding: "2px 0" }}>
    {[0, 1, 2].map((i) => (
      <motion.span
        key={i}
        style={{
          width: 5, height: 5, borderRadius: "50%",
          background: W.accent, display: "block",
        }}
...
export const MoodPicker = ({ onSelect, loading }) => (
  <div style={{
    ...
    <p style={{
      ...
      color: W.textSub, textTransform: "uppercase",
    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 6 }}>
      {MOODS.map((m, i) => (
        ...
        >
          ...
          <span style={{
            fontFamily: FONT_BODY, fontSize: 8.5, fontWeight: 500,
            color: W.textSub, textAlign: "center",
          }}>
            {m.label}
          </span>
        </motion.button>
  ...
  >
    <button
      ...
      style={{
        ...
        color: W.textDim, transition: "color 0.12s",
      }}
    ...
    <div style={{ display: "flex", alignItems: "flex-start", gap: 9 }}>
      ...
      <div>
        ...
        <p style={{
          ...
          color: W.text, margin: 0, lineHeight: 1.5, paddingRight: 14,
        }}>
          {message}
        </p>
      </div>
    ...
    {isOpen ? (
      ...
      >
        <svg width="25" height="25" viewBox="0 0 24 24" fill="none">
          <path d="M20 2H4C2.9 2 2 2.9 2 4v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" fill="white" fillOpacity="0.95" />
          <path d="M16 6.5l.5 1.5 1.5.5-1.5.5-.5 1.5-.5-1.5L14 8.5l1.5-.5z" fill="#e5181e" fillOpacity="0.95" />
...
export const HeaderIconBtn = ({ onClick, title, active, accentActive, children }) => (
  <button
    onClick={onClick}
    title={title}
    style={{
      background: active && accentActive ? W.accentSoft : active ? W.surfaceMid : "transparent",
