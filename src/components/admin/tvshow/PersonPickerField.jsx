// src/components/admin/tvshow/PersonPickerField.jsx
// Ô chọn diễn viên/đạo diễn dùng chung cho TvShowAddModal & TvShowEditModal.
// Hỗ trợ:
//   1) Autocomplete tìm Person có sẵn trong DB (tvShowService.searchPersons) → chọn = gắn PersonId
