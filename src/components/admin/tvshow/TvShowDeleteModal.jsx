// src/components/admin/tvshow/TvShowDeleteModal.jsx
...
/**
 * Props:
 *   show      – object { id, title, posterUrl, numberOfSeasons, tmdbId } | null
 *   onClose   – () => void
            ...
            <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <div style={{ display: 'flex', gap: 14, alignItems: 'center', padding: '12px 14px', borderRadius: 10, background: T.surfaceAlt, border: `1px solid ${T.border}` }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontFamily: FONT, fontSize: 11, color: T.textMuted, marginTop: 2 }}>
                      {show?.numberOfSeasons > 0 ? `${show.numberOfSeasons} mùa` : ''}
                      {show?.numberOfSeasons > 0 && show?.tmdbId ? ' · ' : ''}
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start', padding: '12px 14px', borderRadius: 10, background: '#FEF2F2', border: '1px solid rgba(220,38,38,0.2)' }}>
                ...
                <p style={{ fontFamily: FONT, fontSize: 13, color: '#991B1B', lineHeight: 1.65, margin: 0 }}>
                  Hành động này <strong>không thể hoàn tác</strong>. Toàn bộ dữ liệu liên quan đến TV show này (các mùa, tập phim, bình luận) sẽ bị xóa vĩnh viễn.
                </p>
              </div>
