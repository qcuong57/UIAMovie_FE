...
export default function TvShowEditModal({ show, onClose, onSaved }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      onSaved?.({ ...show, title: form.title.trim(), description: form.description.trim(), rating });
      onClose();
    } catch (e) {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14, fontFamily: FONT }}>
        ...
        <LightTextarea
          label="Mô tả"
          placeholder="Nội dung mô tả TV show..."
