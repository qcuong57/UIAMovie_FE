...
export default function ActorCard({ actor, index, onActorClick }) {
  ...
  return (
    /*
     * Kiến trúc 3 lớp — giống MovieCard, tách entrance vs hover:
     *   1. <div>          → giữ chỗ grid
     *   2. <motion.div>   → entrance: scale + y + opacity (Netflix ease)
     *   3. <div>          → hover: CSS transition transform
     */
    <div>
      <motion.div
