...
// ── Dùng UserReviewsSection (marquee thật) thay MultiMovieReviewsSection ──────
...
export default function HomePage() {
  ...
  const toggleFavorite = (movie) =>
    setFavorites((prev) => {
      ...
      next.has(String(movie.id))
        ? next.delete(String(movie.id))
  ...
  if (error) return <ErrorScreen message={error} onRetry={() => { hasFetched.current = false; fetchData(); }} />;
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <div style={{ padding: isMobile ? "0 16px 0" : "0 48px 0" }}>
            <MovieRow
