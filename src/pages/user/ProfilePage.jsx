          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Lưu ý: Nếu chỉ muốn{" "}
                  <strong style={{ color: "#bfdbfe" }}>không gia hạn</strong>{" "}
                  sau khi hết hạn, bạn không cần làm gì — gói sẽ tự động kết
                  thúc.
                </span>
              </div>
            </div>
            ...
            >
              <motion.button
                ...
                disabled={loading}
                whileHover={
                  !loading ? { background: "rgba(255,255,255,0.08)" } : {}
                }
                style={{
                  padding: "9px 18px",
                  borderRadius: 8,
...
function PlanCard({ user, onUpgrade, onCancelSuccess, onCancelled }) {
  ...
  const handleCancel = async () => {
    ...
    try {
      ...
      await paymentService.cancelMySubscription();
      setShowCancel(false);
      // Cập nhật state cha ngay lập tức — không cần reload trang
      onCancelled?.();
      onCancelSuccess?.(
        "Đã hủy gói Premium thành công. Tài khoản chuyển về Miễn phí.",
      );
    } catch (e) {
      ...
      <>
        ...
        <motion.div
          ...
          style={{
            borderRadius: 12,
            background:
              "linear-gradient(135deg, rgba(234,179,8,0.1) 0%, rgba(180,83,9,0.08) 100%)",
        ...
        >
          ...
          {(startDate || endDate) && (
            <div
              style={{
                display: "grid",
                gridTemplateColumns: startDate && endDate ? "1fr 1fr" : "1fr",
                gap: 8,
              }}
            >
              {startDate && (
              ...
              {endDate && (
                ...
                >
                  <CalendarDays
                    size={13}
                    color={isExpiringSoon ? "#f87171" : "rgba(250,204,21,0.5)"}
                    style={{ marginTop: 2, flexShrink: 0 }}
                  />
                  <div>
                    <div
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 11,
                    fontWeight: 700,
                    color: isExpiringSoon ? "#f87171" : "#facc15",
                    fontFamily: "'Nunito', sans-serif",
                  }}
                >
                  {remaining} ngày
          ...
          >
            ...
            >
              ...
              <strong style={{ color: "rgba(255,255,255,0.5)" }}>
                tự động kết thúc khi hết hạn
              </strong>{" "}
              — không bị trừ phí thêm, không cần hủy thủ công.
            </span>
          </div>
  ...
  return (
    <motion.div
      ...
      style={{
        borderRadius: 12,
        background:
          "linear-gradient(135deg, rgba(70,211,105,0.08) 0%, rgba(34,197,94,0.05) 100%)",
...
export default function ProfilePage() {
  ...
  const handleChangePassword = async () => {
    ...
    if (newPass.length < 6) {
      showToast("Mật khẩu mới ít nhất 6 ký tự", "error");
      return;
    }
    if (newPass !== confirmP) {
    ...
    >
      ...
      <motion.div
        ...
        style={{
          maxWidth: 620,
          margin: "0 auto",
          padding: isMobile ? "20px 16px 48px" : "36px 20px 60px",
        }}
      >
        {/* ── Thông tin cá nhân ── */}
        <SectionCard
        ...
        <SectionCard
          ...
          subtitle={
            isPremium
              ? "Thông tin gói Premium của bạn"
              : "Nâng cấp để mở khoá toàn bộ nội dung"
          }
        >
          <PlanCard
            user={userDetail}
        ...
        >
          ...
          <ArrowLeft
            size={16}
            style={{ color: C.sub, transform: "rotate(180deg)" }}
          />
        </motion.button>
      </motion.div>
